...
var router=function(){
    ...
    Router.post('/change-password',checkToken,userController.UserChangePassword)
    //Router.post('/update',checkToken,userController.UpdateUserProfile)
    Router.post('/userRegistration',userController.UserRegistration)
    Router.post('/userLogin',userController.UserLogin)
    
    
    Router.post('/update', upload.single('image'),checkToken,userController.UpdateUserProfile)
    return Router;
}
